package com.example.administrator.volleydongnao.http.download.dao;

import android.database.Cursor;

import com.example.administrator.volleydongnao.db.BaseDao;
import com.example.administrator.volleydongnao.http.download.DownloadItemInfo;
        ...
        synchronized (DownLoadDao.class){
            ...
            for(int i=0; i< downloadItemInfoList.size(); i++){
                ...
                if(downloadItemInfo.getStatus() != DownloadStatus.failed.getValue()
                        &&  downloadItemInfo.getStopMode() !=  DownloadStopMode.hand.getValue()
